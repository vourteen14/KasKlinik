<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
	<ul class="app-menu list-unstyled accordion" id="menu-accordion">
		<li class="nav-item">
			<a class="nav-link <?php echo $isPage == 'dashboard' ? 'active' : ''; ?>" href="./index.php">
				<span class="nav-icon">
		...
		<li class="nav-item has-submenu">
			<a class="nav-link submenu-toggle <?php echo $isPage == 'data-pasien' || $isPage == 'data-tindakan' ? 'active' : ''; ?>" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false" aria-controls="submenu-1">
				<span class="nav-icon">
		...
		<li class="nav-item has-submenu">
			<a class="nav-link submenu-toggle <?php echo $isPage == 'penerimaan-kas' || $isPage == 'pengeluaran-kas' ? 'active' : ''; ?>" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-2" aria-expanded="false" aria-controls="submenu-2">
				<span class="nav-icon">
